...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <h2 class="mb-4">Terms of Service Management</h2>
            ...
            <div class="card mb-4">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        {{ isset($page) ? 'Edit Terms of Service' : 'Add Terms of Service' }}
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{ isset($page) ? route('terms.of.service.update', $page->id) : route('terms.of.service.store') }}" 
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            @if(isset($page))
                                <a href="{{ route('terms.of.service') }}" class="btn btn-secondary me-md-2">
                                    Cancel Edit
                                </a>
            ...
            <div class="card">
                <div class="card-header bg-dark text-white">
                    <h5 class="mb-0">Current Terms of Service</h5>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('terms.of.service') }}" class="btn btn-sm btn-warning mb-1" title="Edit">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <form action="{{ route('terms.of.service.delete', $page->id) }}" 
                                              method="POST" 
                                              class="d-inline"
                                              onsubmit="return confirm('Are you sure you want to delete these Terms of Service?');">
                                            @csrf
            ...
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    <p class="text-muted mb-0">No Terms of Service found. Add one using the form above!</p>
                </div>
            </div>
            @endif
        </div>
...
<script>
    ...
    const form = document.querySelector('form'); // ✅ Form ko select karo
    ...
    function initEditor() {
        ClassicEditor
            ...
            .then(editor => {
                ...
                // ✅ Har keystroke par data sync karo
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            if (editorInstance) {
                ...
                console.log('Editor data:', editorData.length, 'characters');
