...
@section('title', 'Return & Refund Policy Management')
@section('content')
...
<div class="page-container">
    ...
    <div class="page-header">
        <h1 class="page-title">🔄 Return & Refund Policy Management</h1>
        <p class="page-subtitle">Manage the website's Return & Refund Policy.</p>
    </div>
    ...
    <div class="page-card">
        <div class="{{ isset($page) ? 'card-header-warning' : 'card-header-gradient' }}">
            <h2 class="card-header-title">
                @if(isset($page))
                    <i class="fas fa-pen"></i> Edit Return & Refund Policy
                @else
                    <i class="fas fa-plus-circle"></i> Add Return & Refund Policy
                @endif
            </h2>
        </div>
        <div class="card-body">
            <form action="{{ isset($page) ? route('return.refund.policy.update', $page->id) : route('return.refund.policy.store') }}"
                  method="POST"
                  id="returnRefundPolicyForm">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                           ...
                           placeholder="Enter return & refund policy heading"
                           required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror"
                              ...
                              placeholder="Enter return & refund policy description"
                ...
                <div class="btn-group-custom">
                    @if(isset($page))
                        <a href="{{ route('return.refund.policy') }}" class="btn btn-secondary">
    ...
    <div class="page-card">
        <div class="card-header-dark">
            <h2 class="card-header-title"><i class="fas fa-file-alt"></i> Current Return & Refund Policy</h2>
        </div>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <div style="display:flex; gap:5px; align-items:center; justify-content:center;">
                                    <a href="{{ route('return.refund.policy') }}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <form action="{{ route('return.refund.policy.delete', $page->id) }}"
                                          method="POST" class="d-inline"
                                          onsubmit="return confirmDelete(event, 'Return & Refund Policy')">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="modal-overlay" id="previewModal">
        <div class="modal-box-lg">
            <div class="modal-hdr">
                <h6><i class="fas fa-file-alt"></i> {{ $page->heading }}</h6>
    ...
    <div class="page-card">
        <div class="card-body">
            <div class="empty-state">
                ...
                <p>Koi Return & Refund Policy nahi mili. Upar form se add karein!</p>
            </div>
        </div>
    </div>
    @endif
...
<script>
    ...
    const form = document.getElementById('returnRefundPolicyForm');
        ...
        form.addEventListener('submit', function (e) {
            if (editorInstance) {
                ...
                if (!data || data.trim() === '' || data === '<p>&nbsp;</p>') {
                    e.preventDefault();
                    alert('⚠️ Please enter Return & Refund Policy description!');
                    return false;
                }
            } else {
