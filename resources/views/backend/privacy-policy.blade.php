...
<div class="page-container">
    ...
    <div class="page-card">
        <div class="{{ isset($page) && request()->routeIs('privacy.policy.edit') ? 'card-header-warning' : 'card-header-gradient' }}">
            <h2 class="card-header-title">
                @if(isset($page))
                    <i class="fas fa-pen"></i> Edit Privacy Policy
                @else
                    <i class="fas fa-plus-circle"></i> Add Privacy Policy
                @endif
            </h2>
        </div>
        <div class="card-body">
    ...
    <div class="page-card">
        <div class="card-header-dark">
            <h2 class="card-header-title"><i class="fas fa-file-alt"></i> Current Privacy Policy</h2>
        </div>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <div style="display:flex; gap:5px; align-items:center; justify-content:center;">
                                    <a href="{{ route('privacy.policy') }}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <form action="{{ route('privacy.policy.delete', $page->id) }}"
                                          method="POST" class="d-inline"
                                          onsubmit="return confirmDelete(event, 'Privacy Policy')">
                                        @csrf
    ...
    <div class="page-card">
        <div class="card-body">
            <div class="empty-state">
                ...
                <p>Koi Privacy Policy nahi mili. Upar form se add karein!</p>
            </div>
        </div>
    </div>
    @endif
