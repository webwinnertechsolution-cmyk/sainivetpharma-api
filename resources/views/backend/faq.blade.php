        ...
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0" id="formTitle">
                        {{ isset($editFaq) ? 'Edit FAQ' : 'Add New FAQ' }}
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{ isset($editFaq) ? route('faq.update', $editFaq->id) : route('faq.store') }}" 
                        ...
                        @if(isset($editFaq))
                            <a href="{{ route('faq') }}" class="btn btn-secondary me-md-2">
                                Cancel Edit
                            </a>
            ...
            <div class="card">
                <div class="card-header bg-dark text-white">
                    <h5 class="mb-0">All FAQs ({{ $faqCount }})</h5>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ Str::limit(strip_tags($faq->description), 100) ?: '-' }}</td>
                                    <td>
                                        <small>{{ $faq->created_at->format('d M Y') }}</small><br>
                                ...
                                <tr>
                                    <td colspan="5" class="text-center py-4">
                                        <div class="text-muted">
                                            ...
                                            <p class="mb-0">No FAQs found. Add your first FAQ above!</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse
