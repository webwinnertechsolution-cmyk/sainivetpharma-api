...
<div class="page-container">
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">
                <i class="fas fa-newspaper" style="color: #1872B5;"></i> Blog Posts
            </h1>
            <p class="page-subtitle">Manage all your blog posts</p>
        </div>
            ...
            @else
                <div class="empty-state">
                    ...
                    <p style="font-size: 11px;">
                        <a href="{{ route('blog.create') }}" style="color: #1872B5;">Create your first blog post</a> to get started!
                    </p>
                </div>
            @endif
        </div>
