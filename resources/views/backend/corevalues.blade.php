...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    /* Image / Icon preview */
    .img-preview-box {
        margin-top: 8px; padding: 8px 10px; background: #f0f4f8;
    ...
    .icon-preview-box {
        margin-top: 8px; padding: 8px 12px; background: #f0f4f8;
        border-radius: 6px; display: inline-flex; align-items: center; gap: 8px;
    }
    .icon-preview-box i { font-size: 28px; color: #DA200B; }
    .icon-preview-box p { font-size: 10px; color: #6b7280; margin: 0; }
    ...
    .icon-cell {
        width: 72px; height: 46px; background: #fff5f5;
        border-radius: 6px; border: 1px solid #fecaca;
        display: flex; align-items: center; justify-content: center;
        font-size: 22px; color: #DA200B;
    }
                ...
                <form action="{{ isset($editCoreValue) ? route('corevalues.update', $editCoreValue->id) : route('corevalues.store') }}"
                    ...
                    <div class="form-group">
                        <label class="form-label">
                            Image or Icon
                            @if(!isset($editCoreValue)) <span class="text-danger">*</span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               name="heading"
                               value="{{ old('heading', $editCoreValue->heading ?? '') }}"
                    ...
                    <div class="btn-group-custom">
                        @if(isset($editCoreValue))
                            <a href="{{ route('corevalues') }}" class="btn btn-secondary">
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th style="width:90px">Image / Icon</th>
                                <th>Heading</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    <div style="font-size:11px;color:#0a214f;font-weight:600;">{{ $coreValue->created_at->format('d M Y') }}</div>
                                    <div style="font-size:10px;color:#6b7280;">{{ $coreValue->created_at->format('h:i A') }}</div>
                                </td>
                                <td style="text-align:center;">
                                    <div style="display:flex;gap:5px;align-items:center;justify-content:center;">
                                        ...
                                        <form action="{{ route('corevalues.delete', $coreValue->id) }}"
                                              ...
                                              onsubmit="return confirmDelete(event, '{{ addslashes($coreValue->heading) }}')">
                                            @csrf
