...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .checkbox-item:hover { border-color: #1872B5; background: #eff6ff; }
    .checkbox-item input[type="checkbox"] {
        cursor: pointer; width: 16px; height: 16px;
        accent-color: #1872B5; flex-shrink: 0;
    }
    .checkbox-item input[type="checkbox"]:checked + label { color: #0a214f; font-weight: 600; }
    .checkbox-item label {
        cursor: pointer; margin: 0; font-size: 12px;
        color: #374151; flex: 1; user-select: none;
    }
...
<div class="page-container">
    ...
    <div class="breadcrumb-bar">
        ...
        <span class="sep">›</span>
        <a href="{{ route('blog') }}">Blog Management</a>
        <span class="sep">›</span>
        <span>{{ isset($editBlog) ? 'Edit Post' : 'Add New Post' }}</span>
    </div>
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">
                <i class="fas fa-{{ isset($editBlog) ? 'edit' : 'plus-circle' }}" style="color: #1872B5;"></i>
                {{ isset($editBlog) ? 'Edit Blog Post' : 'Add New Blog Post' }}
            </h1>
            <p class="page-subtitle">{{ isset($editBlog) ? 'Update your existing blog post' : 'Create a new blog post' }}</p>
        </div>
    ...
    {{-- FORM --}}
    <form id="blogForm"
          action="{{ isset($editBlog) ? route('blog.update', $editBlog->id) : route('blog.store') }}"
...
// Initialize slug preview on load
